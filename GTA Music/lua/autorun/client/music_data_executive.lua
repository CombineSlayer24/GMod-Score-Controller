local musicSets = {
	...
	powerplay_bespoke = {
		...
		intensity = {
			...
			high = { { 3, 5, 6 }, { 4, 5, 6 }, { 2, 3, 4, 5, 6 }, { 1, 2, 3, 5, 6 }, { 1, 5, 6 } },
			extreme = { { 1, 2, 3, 5, 6 }, { 1, 2, 3, 4, 5, 6 }, { 2, 3, 4, 5, 6 } },
			cooldown = { 5 }
		}
	},

	powerplay_carsteal = {
		name = "PowerPlay Carsteal",
		gameOrigin = "GTA: Online",
		composer = "James Curd, Lee Thompson",
	...
	powerplay_cliff12 = {
		...
		intensity = {
			low = { { 2 }, { 1, 2 }, { 2, 5 } },
			medium = { { 1, 2, 3 }, { 2, 3, 5 }, { 1, 2, 4, 5 } },
			high = { { 1, 2, 3, 5, 6 }, { 1, 2, 3, 4, 5, 6 }, { 2, 3, 5, 6 } },
	...
	powerplay_gotmove = {
		name = "PowerPlay Get On The Move",
		gameOrigin = "GTA: Online",
		composer = "James Curd, Lee Thompson",
		category = "Executive Update",
		...
		intensity = {
			low = { { 1 }, { 1, 2 }, { 1, 5 } },
			medium = { { 1, 2, 3 }, { 1, 3, 5 }, { 1, 2, 4, 5 } },
			high = { { 1, 2, 3, 5, 6 }, { 1, 3, 4, 5, 6 }, { 1, 3, 5, 6 } },
			extreme = { { 1, 2, 3, 4, 5, 6 }, { 1, 2, 3, 5, 6 } },
			cooldown = { 5 }
		}
	},
	...
	powerplay_popo = {
		...
		intensity = {
			...
			extreme = { { 1, 2, 3, 4, 5, 6 }, { 2, 3, 4, 5, 6 } },
			cooldown = { 5 }
		}
	},

	powerplay_psycho = {
		name = "PowerPlay Psycho",
		gameOrigin = "GTA: Online",
		composer = "James Curd, Lee Thompson",
		category = "Executive Update",
